...
var jwt_1 = require("../core/auth/jwt");
var UserModel_1 = __importDefault(require("../models/UserModel"));
var PwdHash = require('../core/auth/PwdHash');
var AuthController = /** @class */ (function () {
    function AuthController() {
        var _this = this;
        this.Login = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var resultUser, user, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UserModel_1.default.findByEmail(req.body.email)];
                    case 1:
                        resultUser = _a.sent();
                        if (!resultUser) {
